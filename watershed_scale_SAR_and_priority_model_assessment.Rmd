...
main_map = ggplot() +
  ...
  labs(title = paste0("ZQM model risk factor"),
...
ggrepel::geom_label_repel(data = labelpoint, 
                  aes(label = "Sockeye Salmon and Cultus Pygmy Sculpin", geometry = geom),stat = 'sf_coordinates', size = 3, nudge_y = -18000, nudge_x = ) +
...
cols<-c("#007bff", "#ff7f00", "#228b22", "purple")
#cols<-col_ramp(4)
zqpmUseFiltCopy<-zqpmUseFilt
