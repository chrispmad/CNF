...
>>>>>>> 3a4f38e94c570c15c770f2337657dd116d7d644f
...
sara |> 
  filter(Scientific_Name %in% c("Oncorhynchus nerka"))
# sara = sara |> 
#   filter(
...
SARA-listed species included in this assessment: `r paste0(unique(sara$Common_Name_EN), collapse = ', ')`.
...
sara_by_wb = sara %>%
  ...
  sf::st_drop_geometry() %>% 
  dplyr::select(Common_Name_EN,GNIS_NA)
...
ggplot() + 
  ...
  # scale_colour_manual(values =  sp_colors, na.value = "grey")+
